    ...
    <div className="site-shell">
      ...
      <main id="top">
        ...
        <section className="section connect-section" id="connect">
          <div className="connect-copy"><div className="section-kicker"><span>10</span><span>Let’s connect</span></div><h2>Come see the<br /><em>village in action.</em></h2><p>Questions about the program, the campus, or finding your place at VSOP? Start a conversation with our admissions team.</p><div className="contact-details"><div><span>Find us</span><strong>Block 6 Lot 8, Durian St.<br />Violago Homes, Parkwood Hills</strong></div><div><span>Reach us</span><strong>Call the school office<br />or message on Facebook</strong></div></div></div><form className="tour-form" onSubmit={handleTourRequest}><div className="form-label">Request a school visit <Sparkles size={15} /></div><label>Your name<input required name="name" placeholder="Parent or guardian name" /></label><label>Email address<input required type="email" name="email" placeholder="you@example.com" /></label><label>What can we help with?<select name="interest" defaultValue="visit"><option value="visit">Plan a campus visit</option><option value="admissions">Ask about admissions</option><option value="sports">Ask about sports & clubs</option><option value="other">Something else</option></select></label><button className="button button-dark" type="submit">Send enquiry <ArrowRight size={16} /></button><small>We’ll use your details only to respond to this enquiry.</small></form>
        </section>
      </main>
